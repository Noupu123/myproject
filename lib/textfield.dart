...
class TextFieldScreen extends StatefulWidget {
  ...
  @override
  State<TextFieldScreen> createState() => TextFieldScreenstate();
}
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  border: InputBorder.none,
                  enabledBorder: UnderlineInputBorder( borderSide: BorderSide(color: Colors.green,width: 5),),
                  focusedBorder: OutlineInputBorder(
                      borderSide: BorderSide(color: Colors.red,width: 2)),
                ),
              ),
